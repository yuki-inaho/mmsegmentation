...
**Python 3.10 / torch 2.1.0+cu121 / mmcv 2.1.0 / mmengine 0.10.7 / mmseg 1.2.2**.
...
wheel; `MMCV_MAX='2.2.0'` / `MMENGINE_MAX='1.0.0'` (mmseg `__init__.py` guards) are
satisfied by mmcv 2.1.0 + mmengine 0.10.7. `ftfy`/`regex` are included because
